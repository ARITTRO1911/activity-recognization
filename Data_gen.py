def dataset():
    ...
    #Acc code begin
    #fp=open("stand.csv","w")
    fp=open("../input/testtraindata/Train_Set/barnali1/Train_WALKING_DOWNSTAIRS.csv","w")
    activity="walking_downstairs"
    print("activity,ax,ay,az,gx,gy,gz",file=fp)
    ...
    while count <=599:
        ...
        if count>299 and count < 550:       
        	...
        	print(activity,",",Xaxis,",",Yaxis,",",Zaxis,",",pitch,",",roll,",",yaw,file=fp)
        count=count+1
